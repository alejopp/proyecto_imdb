package com.example.alejobootcampandroid.presentation.ui.profile.view.adapters
...
class ProfileOptionsAdapter(val userOptionsList : List<ProfileOptionsModel>): RecyclerView.Adapter<ProfileOptionsAdapter.UserOptionsViewHolder>() {
