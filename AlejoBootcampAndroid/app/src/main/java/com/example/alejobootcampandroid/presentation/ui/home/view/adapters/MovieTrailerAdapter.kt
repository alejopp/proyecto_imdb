...
class MovieTrailerAdapter(val movieTrailerList: List<MovieTrailerModel>): RecyclerView.Adapter<MovieTrailerAdapter.MovieTrailerViewHolder>() {
    ...
    inner class MovieTrailerViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        fun render(movieTrailerItem: MovieTrailerModel) {
